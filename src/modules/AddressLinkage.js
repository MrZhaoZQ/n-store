var provinceList = [
	...
	{name:'重庆市', cityList:[		   
		{name:'重庆市', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','江津市','合川市','永川市','南川市',
	...
	{name:'新疆', cityList:[		   
		...
		{name:'自治区直辖县级行政单位', areaList:['石河子市','阿拉尔市','图木舒克市','五家渠市']}
	]},
	{name:'河北省', cityList:[		   
...
var AddressLinkage = {
	init_3linkage(cmbProvince, cmbCity, cmbArea, defaultProvince, defaultCity, defaultArea){
...
export default AddressLinkage;

//初始化方法
//init_3linkage('cmbProvince', 'cmbCity', 'cmbArea');
//init_3linkage("cmbProvince", "cmbCity", "cmbArea", "河南", "周口市", "川汇区");
